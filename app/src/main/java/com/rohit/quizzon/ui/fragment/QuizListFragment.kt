...
@AndroidEntryPoint
class QuizListFragment : Fragment(), QuizClickListener {
    ...
    private val args: QuizListFragmentArgs by navArgs()
    ...
    override fun quizClickListener(quizListBody: QuizResponse) {
        findNavController().navigate(
            QuizListFragmentDirections.actionQuizListFragmentToQuizFragment(
                quizListBody
            )
        )
    }
